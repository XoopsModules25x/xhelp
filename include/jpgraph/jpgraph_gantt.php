        ...
        if ($this->img->img === null) {
            ...
            if (!$this->scale->IsDisplayDay() && !$this->scale->IsDisplayHour()
                && !(($this->scale->week->iStyle == WEEKSTYLE_FIRSTDAYWNBR
                      || $this->scale->week->iStyle == WEEKSTYLE_FIRSTDAY2WNBR)
    ...
    public function StrokeWeeks($aYCoord, $getHeight = false)
    {
        if ($this->week->iShowLabels) {
            ...
            for ($i = 0; $i < $this->GetNumberOfDays() / 7; ++$i, $x += $weekwidth) {
                ...
                } elseif ($this->week->iStyle == WEEKSTYLE_FIRSTDAY || $this->week->iStyle == WEEKSTYLE_FIRSTDAYWNBR) {
                    $txt = date('j/n', $week);
                ...
                if ($this->week->iStyle == WEEKSTYLE_FIRSTDAYWNBR || $this->week->iStyle == WEEKSTYLE_FIRSTDAY2WNBR) {
