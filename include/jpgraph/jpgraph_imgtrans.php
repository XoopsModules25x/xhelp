...
class imgtrans
{
    ...
    public function Skew3D(
        ...
        return $this->_Skew3D($this->gdImg, $aHorizon, $aSkewDist, $aDir, $aHiQuality, $aMinSize, $aFillColor, $aBorder);
    }

    public function _Skew3D(
        $aGdImg,
        $aHorizon = 120,
        $aSkewDist = 150,
        $aDir = SKEW3D_DOWN,
