            ...
            */
            ...
            if ($this->grad) {
                ...
                if (is_array($this->grad_fromcolor)) {
                    ...
                    if ($ng === 3) {
                        if (is_numeric($this->grad_fromcolor[0]) && $this->grad_fromcolor[0] > 0
                            && $this->grad_fromcolor[0] < 256) {
                            // RGB Triple
            ...
            for ($j = 0; $j < $this->nbrplots; ++$j) {
                ...
                if ($this->plots[$j]->grad) {
                    ...
                    if (is_array($this->plots[$j]->grad_fromcolor)) {
                        ...
                        if ($ng === 3) {
                            if (is_numeric($this->plots[$j]->grad_fromcolor[0])
                                && $this->plots[$j]->grad_fromcolor[0] > 0
