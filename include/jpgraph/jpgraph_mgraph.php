...
class mgraph
{
    ...
    public function Stroke($aFileName = '')
    {
        ...
        for ($i = 0; $i < $this->iCnt; ++$i) {
            $image->CopyMerge($this->iGraphs[$i][0], $this->iGraphs[$i][1] + $this->lm, $this->iGraphs[$i][2] + $this->tm, $this->iGraphs[$i][3], $this->iGraphs[$i][4], $this->iGraphs[$i][5], $this->iGraphs[$i][6], -1, -1, /* Full from width and height */
                              $this->iGraphs[$i][7]);
        }
