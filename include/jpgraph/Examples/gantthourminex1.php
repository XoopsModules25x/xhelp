...
$data = array(
    array(
        0,
        array('Group 1', '345 days', '2004-03-01', '2004-05-05'),
        '2001-11-27 10:00',
        '2001-11-27 14:00',
        FF_FONT2,
        FS_NORMAL,
    ...
    array(
        1,
        array('  Label one', ' 122,5 days', ' 2004-03-01', ' 2003-05-05', 'MJ'),
        '2001-11-27 16:00',
        '2001-11-27 18:00'
    ),
...
$graph->scale->actinfo->SetColTitles(array('Act', 'Duration', 'Start', 'Finish', 'Resp'));//,array(100,70,70,70));
