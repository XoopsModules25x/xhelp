...
class RadarLogTicks extends Ticks
{
    ...
    public function Stroke($aImg, &$grid, $aPos, $aAxisAngle, $aScale, &$aMajPos, &$aMajLabel): void
    {
...
class RadarAxis extends AxisPrototype
{
    ...
    public function Stroke($pos, $aAxisAngle, &$grid, $title, $lf): void
    {
    ...
    public function _StrokeAxisTitle($pos, $aAxisAngle, $title): void
    {
...
{ //extends Grid {
    ...
    public function SetColor($aMajColor): void
    {
    ...
    public function SetLineStyle($aType): void
    {
        $this->type = $aType;
    }

    // Decide if both major and minor grid should be displayed
    public function Show($aShowMajor = true): void
    {
        $this->show = $aShowMajor;
    }

    public function Stroke($img, $grid): void
    {
        if (!$this->show) {
            return;
        }
...
class RadarPlot
{
    ...
    public function SetLineWeight($w): void
    {
        $this->weight = $w;
    }
    ...
    public function SetFill($f = true): void
    {
        $this->fill = $f;
    }

    public function SetColor($aColor, $aFillColor = false): void
    {
        $this->color = $aColor;
        if ($aFillColor) {
    ...
    public function Stroke($img, $pos, $scale, $startangle): void
    {
...
class RadarGraph extends Graph
{
    ...
    public function HideTickMarks($aFlag = true): void
    {
        $this->axis->scale->ticks->SupressTickMarks($aFlag);
    }

    public function ShowMinorTickmarks($aFlag = true): void
    {
        $this->yscale->ticks->SupressMinorTickMarks(!$aFlag);
    }

    public function setScale($axtype, $ymin = 1, $ymax = 1, $dummy1 = null, $dumy2 = null): void
    {
    ...
    public function SetPlotSize($aSize): void
    {
        $this->SetSize($aSize);
    }

    public function SetTickDensity($densy = TICKD_NORMAL, $dummy1 = null): void
    {
    ...
    public function SetPos($px, $py = 0.5): void
    {
        $this->SetCenter($px, $py);
    }

    public function SetCenter($px, $py = 0.5): void
    {
        if ($px >= 0 && $px <= 1) {
    ...
    public function SetTitles($aTitleArray): void
    {
