...
class jpgraph_gradient
{
    ...
    public function SetNumColors($aNum): void
    {
        $this->numcolors = $aNum;
    }
    ...
    public function FilledRectangle($xl, $yt, $xr, $yb, $from_color, $to_color, $style = 1): void
    {
        ...
        switch ($style) {
            ...
            case GRAD_LEFT_REFLECTION:
                ...
                $from_color2 = [
                    min(255, $from_color[0] + $m),
                    min(255, $from_color[1] + $m),
                    min(255, $from_color[2] + $m),
                ];
    ...
    // of a mountain)
    public function FilledFlatPolygon($pts, $from_color, $to_color): void
    {
        if (0 == count($pts)) {
            return;
        }
    ...
    public function GetColArray($from_color, $to_color, $arr_size, &$colors, $numcols = 100): void
    {
        if (0 == $arr_size) {
            return;
        }
        ...
        $prevcolnum    = -1;
        $from_alpha    = (float)$from_color[3];
        $to_alpha      = (float)$to_color[3];
