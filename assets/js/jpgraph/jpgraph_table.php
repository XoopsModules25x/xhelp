...
class GTextTableCell
{
    ...
    public function Init($aTable): void
    {
        $this->iTable = $aTable;
    }
    ...
    public function SetImageConstrain($aType, $aVal): void
    {
    ...
    public function SetCountryFlag($aFlag, $aScale = 1.0, $aMix = 100, $aStdSize = 3): void
    {
        $this->iIcon = new IconPlot();
        $this->iIcon->SetCountryFlag($aFlag, 0, 0, $aScale, $aMix, $aStdSize);
    }

    public function SetImage($aFile, $aScale = 1.0, $aMix = 100): void
    {
        $this->iIcon = new IconPlot($aFile, 0, 0, $aScale, $aMix);
    }

    public function SetImageFromString($aStr, $aScale = 1.0, $aMix = 100): void
    {
        $this->iIcon = new IconPlot('', 0, 0, $aScale, $aMix);
        $this->iIcon->CreateFromString($aStr);
    }

    public function SetRowColSpan($aRowSpan, $aColSpan): void
    {
    ...
    public function SetMerged($aPRow, $aPCol, $aFlg = true): void
    {
        $this->iMerged = $aFlg;
        $this->iPRow   = $aPRow;
        $this->iPCol   = $aPCol;
    ...
    public function SetNumberFormat($aF): void
    {
    ...
    public function SetFont($aFF, $aFS, $aFSize): void
    {
        $this->iFF    = $aFF;
        $this->iFS    = $aFS;
        $this->iFSize = $aFSize;
    ...
    public function SetGridColor($aLeft, $aTop = null, $aBottom = null, $aRight = null): void
    {
        if (null !== $aLeft) {
    ...
    public function SetGridStyle($aLeft, $aTop = null, $aBottom = null, $aRight = null): void
    {
        if (null !== $aLeft) {
    ...
    public function SetGridWeight($aLeft = null, $aTop = null, $aBottom = null, $aRight = null): void
    {
        $weight_arr = [$aLeft, $aTop, $aBottom, $aRight];
        for ($i = 0, $iMax = count($weight_arr); $i < $iMax; ++$i) {
            if ('' === $weight_arr[$i]) {
                $weight_arr[$i] = 0;
            }
        }
        if (null !== $aLeft) {
            $this->iGridWeight[0] = $weight_arr[0];
        }
        if (null !== $aTop) {
            $this->iGridWeight[1] = $weight_arr[1];
        }
        if (null !== $aBottom) {
            $this->iGridWeight[2] = $weight_arr[2];
        }
        if (null !== $aRight) {
            $this->iGridWeight[3] = $weight_arr[3];
        }
    }

    public function SetMargin($aLeft, $aRight, $aTop, $aBottom): void
    {
    ...
    public function SetAlign($aHorAlign = 'left', $aVertAlign = 'bottom'): void
    {
    ...
    public function AdjustMarginsForGrid(): void
    {
        if ($this->iCol > 0) {
    ...
    public function StrokeVGrid($aImg, $aX, $aY, $aWidth, $aHeight, $aDir = 1): void
    {
        ...
        if ((($this->iCol > 0 && 0 == $idx) || ($this->iCol + $this->iColSpan - 1 < $this->iTable->iSize[1] - 1 && 3 == $idx))
    ...
    public function StrokeHGrid($aImg, $aX, $aY, $aWidth, $aHeight, $aDir = 1): void
    {
        ...
        // We don't stroke the grid lines that are on the edge of the table since this is
        // the place of the border.
        if ((($this->iRow > 0 && 1 == $idx) || ($this->iRow + $this->iRowSpan - 1 < $this->iTable->iSize[0] - 1 && 2 == $idx))
            && $this->iGridWeight[$idx] > 0) {
    ...
    public function Stroke($aImg, $aX, $aY, $aWidth, $aHeight): void
    {
        ...
        if (0 != $this->iVal->dir && $this->iVal->font_family >= 10) {
...
class GTextTable
{
    ...
    public function Init($aRows = 0, $aCols = 0, $aFillText = ''): void
    {
        $this->iSize[0] = $aRows;
        $this->iSize[1] = $aCols;
     ...
     *-----------------------------------------------------------------
     */
    public function SetBorder($aWeight = 1, $aColor = 'black'): void
    {
    ...
    public function SetAnchorPos($aXAnchor, $aYAnchor = 'top'): void
    {
     ...
     *-----------------------------------------------------------------
     */
    public function SetCellCountryFlag($aRow, $aCol, $aFlag, $aScale = 1.0, $aMix = 100, $aStdSize = 3): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
     ...
     *-----------------------------------------------------------------
     */
    public function SetCellImage($aRow, $aCol, $aFile, $aScale = 1.0, $aMix = 100): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetRowImage($aRow, $aFile, $aScale = 1.0, $aMix = 100): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColImage($aCol, $aFile, $aScale = 1.0, $aMix = 100): void
    {
        $this->_chkC($aCol);
    ...
    public function SetImage($aFileR1, $aScaleC1 = null, $aMixR2 = null, $aC2 = null, $aFile = null, $aScale = 1.0, $aMix = 100): void
    {
    ...
    public function SetCellImageConstrain($aRow, $aCol, $aType, $aVal): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function toString()
    {
        ...
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
            ...
            for ($j = 0; $j < $this->iSize[1]; ++$j) {
                ...
                $t .= ' (cs=' . $this->iCells[$i][$j]->iColSpan . ', rs=' . $this->iCells[$i][$j]->iRowSpan . ')';
                $t .= '</td>';
            }
            $t .= '</tr>';
        }
     ...
     *-----------------------------------------------------------------
     */
    public function Set($aArg1, $aArg2 = null, $aArg3 = null): void
    {
     ...
     *---------------------------------------------------------------------
     */
    public function SetPadding($aArgR1, $aC1 = null, $aR2 = null, $aC2 = null, $aPad = null): void
    {
    ...
    public function SetRowPadding($aRow, $aPad): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColPadding($aCol, $aPad): void
    {
        $this->_chkC($aCol);
        for ($j = 0; $j < $this->iSize[0]; ++$j) {
    ...
    public function SetCellPadding($aRow, $aCol, $aPad): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
     ...
     *---------------------------------------------------------------------
     */
    public function SetTextOrientation($aArgR1, $aC1 = null, $aR2 = null, $aC2 = null, $aO = null): void
    {
        if (null !== $aC1 && null !== $aR2 && null !== $aC2 && null !== $aPad) {
            $this->_chkR($aArgR1);
            $this->_chkC($aC1);
    ...
    public function SetRowTextOrientation($aRow, $aO): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColTextOrientation($aCol, $aO): void
    {
        $this->_chkC($aCol);
        for ($j = 0; $j < $this->iSize[0]; ++$j) {
    ...
    public function SetCellTextOrientation($aRow, $aCol, $aO): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetColor($aArgR1, $aC1 = null, $aR2 = null, $aC2 = null, $aArg = null): void
    {
    ...
    public function SetRowColor($aRow, $aColor): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColColor($aCol, $aColor): void
    {
        $this->_chkC($aCol);
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
    ...
    public function SetCellColor($aRow, $aCol, $aColor): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetFillColor($aArgR1, $aC1 = null, $aR2 = null, $aC2 = null, $aArg = null): void
    {
        if (null !== $aC1 && null !== $aR2 && null !== $aC2 && null !== $aArg) {
            $this->_chkR($aArgR1);
            $this->_chkC($aC1);
    ...
    public function SetRowFillColor($aRow, $aColor): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColFillColor($aCol, $aColor): void
    {
        $this->_chkC($aCol);
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
    ...
    public function SetCellFillColor($aRow, $aCol, $aColor): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetRowFont($aRow, $aFF, $aFS, $aFSize = 10): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColFont($aCol, $aFF, $aFS, $aFSize = 10): void
    {
        $this->_chkC($aCol);
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
    ...
    public function SetCellFont($aRow, $aCol, $aFF, $aFS, $aFSize = 10): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetAlign($aR1HAlign = null, $aC1VAlign = null, $aR2 = null, $aC2 = null, $aHArg = null, $aVArg = 'center'): void
    {
        if (null !== $aC1VAlign && null !== $aR2 && null !== $aC2 && null !== $aHArg) {
            ...
            $aHArg     = $aR1HAlign;
            $aVArg     = null === $aC1VAlign ? 'center' : $aC1VAlign;
            $aR2       = $this->iSize[0] - 1;
            $aR1HAlign = 0;
            $aC2       = $this->iSize[1] - 1;
            $aC1VAlign = 0;
    ...
    public function SetCellAlign($aRow, $aCol, $aHorAlign, $aVertAlign = 'bottom'): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function SetRowAlign($aRow, $aHorAlign, $aVertAlign = 'bottom'): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function SetColAlign($aCol, $aHorAlign, $aVertAlign = 'bottom'): void
    {
        $this->_chkC($aCol);
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
    ...
    public function SetNumberFormat($aArgR1, $aC1 = null, $aR2 = null, $aC2 = null, $aArg = null): void
    {
        if (null !== $aC1 && null !== $aR2 && null !== $aC2 && null !== $aArg) {
            $this->_chkR($aArgR1);
            $this->_chkC($aC1);
    ...
    public function SetRowNumberFormat($aRow, $aF): void
    {
        $this->_chkR($aRow);
        if (!is_string($aF)) {
            JpGraphError::raiseL(27013); // argument must be a string
    ...
    public function SetColNumberFormat($aCol, $aF): void
    {
        $this->_chkC($aCol);
        if (!is_string($aF)) {
            JpGraphError::raiseL(27013); // argument must be a string
    ...
    public function SetCellNumberFormat($aRow, $aCol, $aF): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
        if (!is_string($aF)) {
    ...
    public function SetMinColWidth($aColWidth, $aWidth = null): void
    {
    ...
    public function SetMinRowHeight($aRowHeight, $aHeight = null): void
    {
        // If there is only one argument this means that all
    ...
    public function SetGrid($aWeight = 1, $aColor = 'black', $aStyle = TGRID_SINGLE): void
    {
        $rc = $this->iSize[0];
        $cc = $this->iSize[1];
        for ($i = 0; $i < $rc; ++$i) {
    ...
    public function SetColGrid($aCol, $aWeight = 1, $aColor = 'black', $aStyle = TGRID_SINGLE): void
    {
        $this->_chkC($aCol);
        for ($i = 0; $i < $this->iSize[0]; ++$i) {
    ...
    public function SetRowGrid($aRow, $aWeight = 1, $aColor = 'black', $aStyle = TGRID_SINGLE): void
    {
        $this->_chkR($aRow);
        for ($j = 0; $j < $this->iSize[1]; ++$j) {
    ...
    public function MergeRow($aRow, $aHAlign = 'center', $aVAlign = 'center'): void
    {
        $this->_chkR($aRow);
        $this->MergeCells($aRow, 0, $aRow, $this->iSize[1] - 1, $aHAlign, $aVAlign);
    }

    public function MergeCol($aCol, $aHAlign = 'center', $aVAlign = 'center'): void
    {
        $this->_chkC($aCol);
        $this->MergeCells(0, $aCol, $this->iSize[0] - 1, $aCol, $aHAlign, $aVAlign);
    }

    public function MergeCells($aR1, $aC1, $aR2, $aC2, $aHAlign = 'center', $aVAlign = 'center'): void
    {
        if ($aR1 > $aR2 || $aC1 > $aC2) {
    ...
    public function SetCSIMTarget($aTarget, $aAlt = null, $aAutoTarget = false): void
    {
        $m    = $this->iSize[0];
        $n    = $this->iSize[1];
        $csim = '';
    ...
    public function SetCellCSIMTarget($aRow, $aCol, $aTarget, $aAlt = null): void
    {
        $this->_chkR($aRow);
        $this->_chkC($aCol);
    ...
    public function _chkC($aCol): void
    {
        if (!$this->iInit) {
    ...
    public function _chkR($aRow): void
    {
        if (!$this->iInit) {
            JpGraphError::raise(27014); // Table not initialized
        }
    ...
    public function _autoSizeTable($aImg): void
    {
    ...
    public function _setcell($aRow, $aCol, $aVal = ''): void
    {
    ...
    public function Stroke($aImg, $aX = null, $aY = null): void
    {
        if (null !== $aX && null !== $aY) {
            $this->iXPos = $aX;
            $this->iYPos = $aY;
