...
class RectPattern
{
    ...
    public function SetBackground($aBackgroundColor): void
    {
        $this->iBackgroundColor = $aBackgroundColor;
    }

    public function SetPos($aRect): void
    {
        $this->rect = $aRect;
    }

    public function ShowFrame($aShow = true): void
    {
        $this->doframe = $aShow;
    }

    public function SetDensity($aDens): void
    {
...
class RectPatternSolid extends RectPattern
{
    ...
    public function DoPattern($aImg): void
    {
        $aImg->SetColor($this->color);
        $aImg->FilledRectangle($this->rect->x, $this->rect->y, $this->rect->xe, $this->rect->ye);
    }
...
class RectPattern3DPlane extends RectPattern
{
    ...
    public function SetHorizon($aHorizon): void
    {
        $this->alpha = $aHorizon;
    }
...
class RectPatternCross extends RectPattern
{
    ...
    public function SetOrder($aDepth): void
    {
...
class PlotBand
{
    ...
    public function ShowFrame($aFlag = true): void
    {
