...
class CanvasScale
{
    ...
    public function Set($xmin = 0, $xmax = 10, $ymin = 0, $ymax = 10): void
    {
        $this->ixmin = $xmin;
        $this->ixmax = $xmax;
        $this->iymin = $ymin;
...
class Shape
{
    ...
    public function SetLineWeight($aWeight): void
    {
        $this->img->SetLineWeight($aWeight);
    }

    public function Polygon($p, $aClosed = false): void
    {
        $n = count($p);
        for ($i = 0; $i < $n; $i += 2) {
    ...
    public function FilledPolygon($p): void
    {
        $n = count($p);
        for ($i = 0; $i < $n; $i += 2) {
            $p[$i]     = $this->scale->TranslateX($p[$i]);
    ...
    // 4=x2, 5=y2
    // 6=x3, 7=y3
    public function Bezier($p, $aSteps = 40): void
    {
        $x0 = $p[0];
        $y0 = $p[1];
    ...
    public function Circle($x1, $y1, $r): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
        if ($r >= 0) {
    ...
    public function FilledCircle($x1, $y1, $r): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
        if ($r >= 0) {
            $r = $this->scale->TranslateX($r);
    ...
    public function RoundedRectangle($x1, $y1, $x2, $y2, $r = null): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
        [$x2, $y2] = $this->scale->Translate($x2, $y2);
    ...
    public function FilledRoundedRectangle($x1, $y1, $x2, $y2, $r = null): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
        [$x2, $y2] = $this->scale->Translate($x2, $y2);
    ...
    public function ShadowRectangle($x1, $y1, $x2, $y2, $fcolor = false, $shadow_width = null, $shadow_color = [102, 102, 102]): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
        [$x2, $y2] = $this->scale->Translate($x2, $y2);
    ...
    public function StrokeText($x1, $y1, $txt, $dir = 0, $paragraph_align = 'left'): void
    {
        [$x1, $y1] = $this->scale->Translate($x1, $y1);
    ...
    public function IndentedRectangle($xt, $yt, $w, $h, $iw = 0, $ih = 0, $aCorner = 3, $aFillColor = '', $r = 4): void
    {
...
class CanvasRectangleText
{
    ...
    public function SetShadow($aColor = 'gray', $aWidth = 3): void
    {
        $this->iShadowColor = $aColor;
        $this->iShadowWidth = $aWidth;
    }

    public function SetFont($FontFam, $aFontStyle, $aFontSize = 12): void
    {
        $this->iTxt->SetFont($FontFam, $aFontStyle, $aFontSize);
    }

    public function SetTxt($aTxt): void
    {
        $this->iTxt->Set($aTxt);
    }

    public function ParagraphAlign($aParaAlign): void
    {
    ...
    public function SetAutoMargin($aMargin): void
    {
    ...
    public function SetPos($xl = 0, $yt = 0, $w = 0, $h = 0): void
    {
        $this->ix = $xl;
        $this->iy = $yt;
        $this->iw = $w;
    ...
    public function Pos($xl = 0, $yt = 0, $w = 0, $h = 0): void
    {
        $this->ix = $xl;
        $this->iy = $yt;
        $this->iw = $w;
    ...
    public function Set($aTxt, $xl, $yt, $w = 0, $h = 0): void
    {
        $this->iTxt->Set($aTxt);
        $this->ix = $xl;
        $this->iy = $yt;
    ...
    public function SetCornerRadius($aRad = 5): void
    {
        $this->ir = $aRad;
    }
    ...
    public function Stroke($aImg, $scale)
    {
        ...
        if ('' != $this->iShadowColor) {
            ...
            $aImg->FilledRoundedRectangle($this->ix + $this->iShadowWidth, $this->iy + $this->iShadowWidth, $this->ix + $this->iw - 1 + $this->iShadowWidth, $this->iy + $this->ih - 1 + $this->iShadowWidth, $this->ir);
            $aImg->PopColor();
        }

        if ('' != $this->iFillColor) {
            $aImg->PushColor($this->iFillColor);
            $aImg->FilledRoundedRectangle($this->ix, $this->iy, $this->ix + $this->iw - 1, $this->iy + $this->ih - 1, $this->ir);
            $aImg->PopColor();
        }

        if ('' != $this->iColor) {
            $aImg->PushColor($this->iColor);
            $aImg->RoundedRectangle($this->ix, $this->iy, $this->ix + $this->iw - 1, $this->iy + $this->ih - 1, $this->ir);
            $aImg->PopColor();
        }
