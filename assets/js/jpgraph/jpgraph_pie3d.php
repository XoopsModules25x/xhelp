...
//===================================================
class jpgraph_pie3d extends PiePlot
{
    ...
    public function SetEdge($aColor = 'black', $aWeight = 1): void
    {
    ...
    public function SetAngle($a): void
    {
        if ($a < 5 || $a > 90) {
    ...
    public function Add3DSliceToCSIM($i, $xc, $yc, $height, $width, $thick, $sa, $ea): void
    {
    ...
    public function Pie3DSlice($img, $xc, $yc, $w, $h, $sa, $ea, $z, $fillcolor, $shadow = 0.65): void
    {
    ...
    public function Pie3D(
        ...
        for ($i = 0, $iMax = count($data); $i < $iMax; ++$i, ++$idx) {
            $da = $data[$i] / $sum * 360;
        ...
        while ($angles[$j][0] < 270 && 2 !== $aaoption) {
            [$x, $y] = $adjexplode[$j];
        ...
        // clockwise
        while ($cnt < $slice_left && 2 !== $aaoption) {
            [$x, $y] = $adjexplode[$j];
    ...
    public function StrokeFullSliceFrame($img, $xc, $yc, $sa, $ea, $w, $h, $z, $edgecolor, $exploderadius, $fulledge): void
    {
        $step = 0.02;
    ...
    public function Stroke($img, $aaoption = 0): void
    {
        ...
        if ($this->radius <= 1) {
            ...
            $width = $this->radius * (1 === $aaoption ? 2 : 1);
        }
    ...
    public function StrokeLabels($label, $img, $a, $xp, $yp, $z): void
    {
