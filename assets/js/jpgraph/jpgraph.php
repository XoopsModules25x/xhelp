...
require_once __DIR__ . '/jpg-config.inc.php';
require_once __DIR__ . '/jpgraph_gradient.php';
require_once __DIR__ . '/jpgraph_errhandler.inc.php';
require_once __DIR__ . '/jpgraph_ttf.inc.php';
require_once __DIR__ . '/jpgraph_rgb.inc.php';
require_once __DIR__ . '/jpgraph_text.inc.php';
require_once __DIR__ . '/jpgraph_legend.inc.php';
require_once __DIR__ . '/jpgraph_theme.inc.php';
require_once __DIR__ . '/gd_image.inc.php';

// Version info
define('JPG_VERSION', '4.2.2');
...
//
function _phpErrorHandler($errno, $errmsg, $filename, $linenum, $vars): void
{
...
class Footer
{
    ...
    public function setTimer($aTimer, $aTimerPostString = ''): void
    {
        $this->iTimer           = $aTimer;
        $this->itimerpoststring = $aTimerPostString;
    }

    public function setMargin($aLeft = 3, $aRight = 3, $aBottom = 3): void
    {
    ...
    public function stroke($aImg): void
    {
...
class Graph
{
    ...
    public function InitializeFrameAndMargin(): void
    {
        $this->doframe      = true;
    ...
    public function setupCache($aFilename, $aTimeout = 60): void
    {
    ...
    public function set3DPerspective($aDir = 1, $aHorizon = 100, $aSkewDist = 120, $aQuality = false, $aFillColor = '#FFFFFF', $aBorder = false, $aMinSize = true, $aHorizonPos = 0.5): void
    {
        $this->iImgTrans           = true;
    ...
    public function setUserFont($aNormal, $aBold = '', $aItalic = '', $aBoldIt = ''): void
    {
        $this->img->ttf->SetUserFont($aNormal, $aBold, $aItalic, $aBoldIt);
    }

    public function setUserFont1($aNormal, $aBold = '', $aItalic = '', $aBoldIt = ''): void
    {
        $this->img->ttf->SetUserFont1($aNormal, $aBold, $aItalic, $aBoldIt);
    }

    public function setUserFont2($aNormal, $aBold = '', $aItalic = '', $aBoldIt = ''): void
    {
        $this->img->ttf->SetUserFont2($aNormal, $aBold, $aItalic, $aBoldIt);
    }

    public function setUserFont3($aNormal, $aBold = '', $aItalic = '', $aBoldIt = ''): void
    {
        $this->img->ttf->SetUserFont3($aNormal, $aBold, $aItalic, $aBoldIt);
    }

    // Set Image format and optional quality
    public function setImgFormat($aFormat, $aQuality = 75): void
    {
        $this->img->SetImgFormat($aFormat, $aQuality);
    }

    // Should the grid be in front or back of the plot?
    public function setGridDepth($aDepth): void
    {
        $this->grid_depth = $aDepth;
    }

    public function setIconDepth($aDepth): void
    {
        $this->iIconDepth = $aDepth;
    }

    // Specify graph angle 0-360 degrees.
    public function setAngle($aAngle): void
    {
        $this->img->SetAngle($aAngle);
    }

    public function setAlphaBlending($aFlg = true): void
    {
        $this->img->SetAlphaBlending($aFlg);
    }

    // Shortcut to image margin
    public function setMargin($lm, $rm, $tm, $bm): void
    {
        $this->img->SetMargin($lm, $rm, $tm, $bm);
    }

    public function setY2OrderBack($aBack = true): void
    {
    ...
    public function set90AndMargin($lm = 0, $rm = 0, $tm = 0, $bm = 0): void
    {
    ...
    public function addTable($aTable): void
    {
        if (is_array($aTable)) {
            for ($i = 0, $iMax = count($aTable); $i < $iMax; ++$i) {
    ...
    public function addIcon($aIcon): void
    {
        if (is_array($aIcon)) {
    ...
    public function addY2($aPlot): void
    {
        if (null === $aPlot) {
    ...
    public function addY($aN, $aPlot): void
    {
        if (null === $aPlot) {
    ...
    public function addText($aTxt, $aToY2 = false): void
    {
        if (null === $aTxt) {
    ...
    public function addLine($aLine, $aToY2 = false): void
    {
        if (null === $aLine) {
    ...
    public function addBand($aBand, $aToY2 = false): void
    {
        if (null === $aBand) {
    ...
    public function setPlotGradient($aFrom = 'navy', $aTo = 'silver', $aGradType = 2): void
    {
    ...
    public function setBackgroundGradient($aFrom = 'navy', $aTo = 'silver', $aGradType = 2, $aStyle = BGRAD_FRAME): void
    {
    ...
    public function setBackgroundCFlag($aName, $aBgType = BGIMG_FILLPLOT, $aMix = 100): void
    {
    ...
    public function setBackgroundCountryFlag($aName, $aBgType = BGIMG_FILLPLOT, $aMix = 100): void
    {
        $this->background_cflag      = $aName;
        $this->background_cflag_type = $aBgType;
        $this->background_cflag_mix  = $aMix;
    ...
    public function setBackgroundImage($aFileName, $aBgType = BGIMG_FILLPLOT, $aImgFormat = 'auto'): void
    {
    ...
    public function setBackgroundImageMix($aMix): void
    {
        $this->background_image_mix = $aMix;
    }

    // Adjust background image position
    public function setBackgroundImagePos($aXpos, $aYpos): void
    {
    ...
    public function setAxisStyle($aStyle): void
    {
        $this->iAxisStyle = $aStyle;
    }

    // Set a frame around the plot area
    public function setBox($aDrawPlotFrame = true, $aPlotFrameColor = [0, 0, 0], $aPlotFrameWeight = 1): void
    {
    ...
    public function setMarginColor($aColor): void
    {
        $this->margin_color = $aColor;
    }

    // Set a frame around the entire image
    public function setFrame($aDrawImgFrame = true, $aImgFrameColor = [0, 0, 0], $aImgFrameWeight = 1): void
    {
    ...
    public function setFrameBevel($aDepth = 3, $aBorder = false, $aBorderColor = 'black', $aColor1 = 'white@0.4', $aColor2 = 'darkgray@0.4', $aFlg = true): void
    {
    ...
    public function setShadow($aShowShadow = true, $aShadowWidth = 5, $aShadowColor = 'darkgray'): void
    {
    ...
    public function setScale($aAxisType, $aYMin = 1, $aYMax = 1, $aXMin = 1, $aXMax = 1): void
    {
    ...
    public function setY2Scale($aAxisType = 'lin', $aY2Min = 1, $aY2Max = 1): void
    {
        if ('lin' == $aAxisType) {
    ...
    public function setYDeltaDist($aDist): void
    {
        $this->iYAxisDeltaPos = $aDist;
    }

    // Specify secondary Y scale
    public function setYScale($aN, $aAxisType = 'lin', $aYMin = 1, $aYMax = 1): void
    {
        if ('lin' == $aAxisType) {
    ...
    public function setTickDensity($aYDensity = TICKD_NORMAL, $aXDensity = TICKD_NORMAL): void
    {
    ...
    public function checkCSIMCache($aCacheName, $aTimeOut = 60)
    {
        ...
        if ('' != $this->csimcachename) {
            ...
            if (is_file($basecsim) && is_file($baseimg)) {
    ...
    public function setCSIMImgAlt($aAlt): void
    {
        $this->iCSIMImgAlt = $aAlt;
    }

    public function strokeCSIM($aScriptName = 'auto', $aCSIMName = '', $aBorder = 0): void
    {
        if ('' == $aCSIMName) {
    ...
    public function strokeCSIMImage(): void
    {
        if (1 == @$_GET[_CSIM_DISPLAY]) {
            $this->Stroke();
        }
    }
    ...
    public function getXMinMax()
    {
        ...
        // values.
        while ((null === $min || null === $max) && ($i < count($this->plots) - 1)) {
            ++$i;
    ...
    public function adjustMarginsForTitles(): void
    {
        $totrequired = ('' != $this->title->t ? $this->title->GetTextHeight($this->img) + $this->title->margin + 5 * SUPERSAMPLING_SCALE : 0) + ('' != $this->subtitle->t ? $this->subtitle->GetTextHeight($this->img) + $this->subtitle->margin + 5 * SUPERSAMPLING_SCALE : 0) + (''
                                                                                                                                                                                                                                                                                   != $this->subsubtitle->t ? $this->subsubtitle->GetTextHeight(
                    $this->img
                ) + $this->subsubtitle->margin + 5 * SUPERSAMPLING_SCALE : 0);
        ...
        if (null != $this->xaxis && !$this->xaxis->hide && !$this->xaxis->hide_labels) {
            ...
            if (90 == $this->img->a) {
                $this->img->SetFont($this->yaxis->font_family, $this->yaxis->font_style, $this->yaxis->font_size);
                $lh = $this->img->GetTextHeight('Mg', $this->yaxis->label_angle);
            } else {
                $this->img->SetFont($this->xaxis->font_family, $this->xaxis->font_style, $this->xaxis->font_size);
        ...
        if (90 == $this->img->a) {
            ...
            if ($this->img->top_margin < $totrequired) {
                $this->SetMargin($this->img->raw_left_margin, $this->img->raw_right_margin, $totrequired / SUPERSAMPLING_SCALE, $this->img->raw_bottom_margin);
            }

            // need more bottom margin
            if ($this->img->bottom_margin < $btotrequired) {
                $this->SetMargin($this->img->raw_left_margin, $this->img->raw_right_margin, $this->img->raw_top_margin, $btotrequired / SUPERSAMPLING_SCALE);
            }
        }
    }

    public function strokeStore($aStrokeFileName): void
    {
        // Get the handler to prevent the library from sending the
        // image to the browser
        $ih = $this->Stroke(_IMGHandler);
    ...
    public function doAutoscaleXAxis(): void
    {
    ...
    public function doAutoScaleYnAxis(): void
    {
    ...
    public function doAutoScaleYAxis(): void
    {
    ...
    public function InitScaleConstants(): void
    {
    ...
    public function doPrestrokeAdjustments(): void
    {
    ...
    public function strokeBands($aDepth, $aCSIM): void
    {
        // Stroke bands
    ...
    public function stroke($aStrokeFileName = '')
    {
        ...
        if ((!$this->yscale->IsSpecified() && 0 == count($this->plots))
            || (null != $this->y2scale && !$this->y2scale->IsSpecified() && 0 == count($this->y2plots))) {
        ...
        // for 'text'
        if (($this->yaxis->pos == $this->xscale->GetMinVal() || (is_string($this->yaxis->pos) && 'min' == $this->yaxis->pos))
            && !is_numeric($this->xaxis->pos)
            && $this->yscale->GetMinVal() < 0
            && 'text' != mb_substr($this->axtype, 0, 4)
            && 'min' != $this->xaxis->pos) {
        ...
        if (DEPTH_FRONT == $this->iIconDepth) {
            $this->StrokeIcons();
        }
    ...
    public function setAxisLabelBackground($aType, $aXFColor = 'lightgray', $aXColor = 'black', $aYFColor = 'lightgray', $aYColor = 'black'): void
    {
    ...
    public function strokeAxisLabelBackground(): void
    {
        // Types
        // 0 = No background
    ...
    public function strokeAxis($aStrokeLabels = true): void
    {
        if ($aStrokeLabels) {
    ...
    public function strokePlotGrad(): void
    {
    ...
    public function strokeBackgroundGrad(): void
    {
    ...
    public function strokeFrameBackground(): void
    {
    ...
    public function strokeFrame(): void
    {
        if (!$this->doframe) {
            return;
        }
        ...
        if ($this->doshadow) {
            ...
            $this->img->ShadowRectangle(0, 0, $this->img->width, $this->img->height, $c, $this->shadow_width, $this->shadow_color);
    ...
    public function fillMarginArea(): void
    {
        $hadj = 0;
        $vadj = 0;
        if ($this->doshadow) {
        ...
        $this->img->FilledRectangle($this->img->left_margin + 1, $this->img->height - $this->img->bottom_margin, $this->img->width - 1 - $hadj, $this->img->height - 1 - $hadj);
        $this->img->FilledRectangle($this->img->width - $this->img->right_margin, $this->img->top_margin + 1, $this->img->width - 1 - $hadj, $this->img->height - $this->img->bottom_margin - 1);
    }

    public function fillPlotArea(): void
    {
        $this->img->PushColor($this->plotarea_color);
        $this->img->FilledRectangle($this->img->left_margin, $this->img->top_margin, $this->img->width - $this->img->right_margin, $this->img->height - $this->img->bottom_margin);
        $this->img->PopColor();
    }

    // Stroke the plot area with either a solid color or a background image
    public function strokePlotArea(): void
    {
    ...
    public function strokeIcons(): void
    {
        $n = count($this->iIcons);
        for ($i = 0; $i < $n; ++$i) {
    ...
    public function strokePlotBox(): void
    {
        ...
        if ($this->boxed) {
            ...
            for ($i = 0; $i < $this->box_weight; ++$i) {
                $this->img->Rectangle($this->img->left_margin - $i, $this->img->top_margin - $i, $this->img->width - $this->img->right_margin + $i, $this->img->height - $this->img->bottom_margin + $i);
            }
        }
    }

    public function setTitleBackgroundFillStyle($aStyle, $aColor1 = 'black', $aColor2 = 'white'): void
    {
    ...
    public function setTitleBackground($aBackColor = 'gray', $aStyle = TITLEBKG_STYLE1, $aFrameStyle = TITLEBKG_FRAME_NONE, $aFrameColor = 'black', $aFrameWeight = 1, $aBevelHeight = 3, $aEnable = true): void
    {
    ...
    public function strokeTitles(): void
    {
        $margin = 3;
    ...
    public function strokeTexts(): void
    {
    ...
    public function strokeTables(): void
    {
    ...
    public function displayClientSideaImageMapAreas(): void
    {
    ...
    public function setTextScaleOff($aOff): void
    {
    ...
    public function setTextScaleAbsCenterOff($aOff): void
    {
    ...
    public function setTheme($graph_theme): void
    {
    ...
    public function clearTheme(): void
    {
        ...
        $this->__construct($this->inputValues['aWidth'], $this->inputValues['aHeight'], $this->inputValues['aCachedName'], $this->inputValues['aTimeout'], $this->inputValues['aInline']);

        if (!($this instanceof PieGraph)) {
            if ($this->isAfterSetScale) {
                $this->setScale($this->inputValues['aAxisType'], $this->inputValues['aYMin'], $this->inputValues['aYMax'], $this->inputValues['aXMin'], $this->inputValues['aXMax']);
            }
        }
    ...
    public function setSupersampling($do = false, $scale = 2): void
    {
        if ($do) {
...
class LineProperty
{
    ...
    public function setStyle($aStyle): void
    {
        $this->iStyle = $aStyle;
    }

    public function show($aShow = true): void
    {
        $this->iShow = $aShow;
    }

    public function stroke($aImg, $aX1, $aY1, $aX2, $aY2): void
    {
        if ($this->iShow) {
...
class GraphTabTitle extends Text
{
    ...
    public function setColor($aTxtColor, $aFillColor = 'lightyellow', $aBorderColor = 'black'): void
    {
    ...
    public function setFillColor($aFillColor): void
    {
        $this->fillcolor = $aFillColor;
    }

    public function setTabAlign($aAlign): void
    {
        $this->align = $aAlign;
    }

    public function setWidth($aWidth): void
    {
        $this->width = $aWidth;
    }

    public function set($t): void
    {
        $this->t    = $t;
        $this->hide = false;
    }

    public function setCorner($aD): void
    {
        $this->corner = $aD;
    }

    public function stroke($aImg, $aDummy1 = null, $aDummy2 = null): void
    {
        if ($this->hide) {
            return;
        }
...
class SuperScriptText extends Text
{
    ...
    public function fromReal($aVal, $aPrecision = 2): void
    {
    ...
    public function set($aTxt, $aSuper = ''): void
    {
        $this->t      = $aTxt;
        $this->iSuper = $aSuper;
    }

    public function setSuperFont($aFontFam, $aFontStyle = FS_NORMAL, $aFontSize = 8): void
    {
    ...
    public function stroke($aImg, $ax = -1, $ay = -1): void
    {
...
class Grid
{
    ...
    public function setColor($aMajColor, $aMinColor = false): void
    {
    ...
    public function setWeight($aMajorWeight, $aMinorWeight = 1): void
    {
    ...
    public function setLineStyle($aMajorType, $aMinorType = 'solid'): void
    {
        $this->majortype = $aMajorType;
        $this->minortype = $aMinorType;
    }

    public function setStyle($aMajorType, $aMinorType = 'solid'): void
    {
        $this->SetLineStyle($aMajorType, $aMinorType);
    }

    // Decide if both major and minor grid should be displayed
    public function show($aShowMajor = true, $aShowMinor = false): void
    {
        $this->show      = $aShowMajor;
        $this->showMinor = $aShowMinor;
    }

    public function setFill($aFlg = true, $aColor1 = 'lightgray', $aColor2 = 'lightblue'): void
    {
        $this->fill      = $aFlg;
...
class AxisPrototype
{
    ...
    public function setLabelFormat($aFormStr): void
    {
        $this->scale->ticks->SetLabelFormat($aFormStr);
    }

    public function setLabelFormatString($aFormStr, $aDate = false): void
    {
        $this->scale->ticks->SetLabelFormat($aFormStr, $aDate);
    }

    public function setLabelFormatCallback($aFuncName): void
    {
        $this->scale->ticks->SetFormatCallback($aFuncName);
    }

    public function setLabelAlign($aHAlign, $aVAlign = 'top', $aParagraphAlign = 'left'): void
    {
    ...
    // Hide zero label
    public function hideZeroLabel($aFlag = true): void
    {
        $this->scale->ticks->SupressZeroLabel();
    }

    public function hideFirstLastLabel(): void
    {
    ...
    // Hide the axis
    public function hide($aHide = true): void
    {
        $this->hide = $aHide;
    }

    // Hide the actual axis-line, but still print the labels
    public function hideLine($aHide = true): void
    {
        $this->hide_line = $aHide;
    }

    public function hideLabels($aHide = true): void
    {
    ...
    // Axis color
    public function setColor($aColor, $aLabelColor = false): void
    {
        $this->color = $aColor;
        if (!$aLabelColor) {
    ...
    // Title on axis
    public function setTitle($aTitle, $aAdjustAlign = 'high'): void
    {
    ...
    // at $start
    public function setTextTickInterval($aStep, $aStart = 0): void
    {
    ...
    public function setTextLabelInterval($aStep): void
    {
        if ($aStep < 1) {
    ...
    public function setLabelSide($aSidePos): void
    {
        $this->labelPos = $aSidePos;
    }

    // Set the font
    public function setFont($aFamily, $aStyle = FS_NORMAL, $aSize = 10): void
    {
    ...
    public function setPos($aPosOnOtherScale): void
    {
    ...
    public function setPosAbsDelta($aDelta): void
    {
        $this->iDeltaAbsPos = $aDelta;
    }

    // Specify the angle for the tick labels
    public function setLabelAngle($aAngle): void
    {
...
class Axis extends AxisPrototype
{
    ...
    // Stroke the axis.
    public function stroke($aOtherAxisScale, $aStrokeLabels = true): void
    {
        if ($this->hide) {
            return;
        }
    ...
    public function strokeLabels($aPos, $aMinor = false, $aAbsLabel = false): void
    {
            ...
            if (0 == ($i % $this->label_step)) {
                ...
                if ('x' == $this->scale->type) {
                    if (SIDE_DOWN == $this->labelPos) {
                        ...
                        $this->img->StrokeText($tpos, $aPos + $this->tick_label_margin, $label, $this->label_angle, $this->label_para_align);
                    } else {
                        if (0 == $this->label_angle || 90 == $this->label_angle) {
                            if ('' == $this->label_halign && '' == $this->label_valign) {
...
class Ticks
{
    ...
    public function setLabelFormat($aFormatString, $aDate = false): void
    {
        $this->label_formatstr     = $aFormatString;
        $this->label_usedateformat = $aDate;
    }

    public function setLabelDateFormat($aFormatString): void
    {
        $this->label_dateformatstr = $aFormatString;
    }

    public function setFormatCallback($aCallbackFuncName): void
    {
        $this->label_formfunc = $aCallbackFuncName;
    }

    // Don't display the first zero label
    public function supressZeroLabel($aFlag = true): void
    {
        $this->supress_zerolabel = $aFlag;
    }

    // Don't display minor tick marks
    public function supressMinorTickMarks($aHide = true): void
    {
        $this->supress_minor_tickmarks = $aHide;
    }

    // Don't display major tick marks
    public function supressTickMarks($aHide = true): void
    {
        $this->supress_tickmarks = $aHide;
    }

    // Hide the first tick mark
    public function supressFirst($aHide = true): void
    {
        $this->supress_first = $aHide;
    }

    // Hide the last tick mark
    public function supressLast($aHide = true): void
    {
    ...
    public function setSize($aMajSize, $aMinSize = 3): void
    {
    ...
    public function setSide($aSide): void
    {
        $this->direction = $aSide;
    }

    // Which side of the axis should the ticks be on
    public function setDirection($aSide = SIDE_RIGHT): void
    {
        $this->direction = $aSide;
    }

    // Set colors for major and minor tick marks
    public function setMarkColor($aMajorColor, $aMinorColor = ''): void
    {
        $this->SetColor($aMajorColor, $aMinorColor);
    }

    public function setColor($aMajorColor, $aMinorColor = ''): void
    {
...
class LinearTicks extends Ticks
{
    ...
    public function set($aMajStep, $aMinStep = false): void
    {
        if (false === $aMinStep) {
            $aMinStep = $aMajStep;
        }
    ...
    public function _doManualTickPos($aScale): void
    {
    ...
    public function _doAutoTickPos($aScale): void
    {
        ...
        if ($aScale->textscale) {
            ...
            if ('x' == $aScale->type) {
                ...
                while (round($abs_pos) <= $limit) {
                    ...
                    if (0 == $step || 0 == $i % $step && $j < $nbrmajticks) {
    ...
    public function adjustForDST($aFlg = true): void
    {
    ...
    public function _doLabelFormat($aVal, $aIdx, $aNbrTicks)
    {
        ...
        if ('' != $this->label_formfunc) {
            ...
            if ($this->label_usedateformat) {
                ...
                if (1 == date('I', $aVal) && $this->iAdjustForDST) {
                    // DST
                    $aVal += 3600;
                }
        ...
        if (($this->supress_zerolabel && 0 == $l) || ($this->supress_first && 0 == $aIdx) || ($this->supress_last && $aIdx == $aNbrTicks - 1)) {
            $l = '';
        }
    ...
    public function _StrokeTicks($aImg, $aScale, $aPos): void
    {
        $hor = 'x' == $aScale->type;
    ...
    // Draw linear ticks
    public function stroke($aImg, $aScale, $aPos): void
    {
    ...
    public function setXLabelOffset($aLabelOff, $aTickOff = -1): void
    {
    ...
    public function setTextLabelStart($aTextLabelOff): void
    {
...
class LinearScale
{
    ...
    // automatic maximum
    public function setAutoMin($aMin): void
    {
    ...
    // Usefull if you want a fix minimum (like 0) but have an
    // automatic maximum
    public function setAutoMax($aMax): void
    {
    ...
    public function setAutoTicks($aFlag = true): void
    {
        $this->auto_ticks = $aFlag;
    }

    // Specify scale "grace" value (top and bottom)
    public function setGrace($aGraceTop, $aGraceBottom = 0): void
    {
    ...
    public function Update($aImg, $aMin, $aMax): void
    {
        $this->scale      = [$aMin, $aMax];
        $this->world_size = $aMax - $aMin;
    ...
    public function setIntScale($aIntScale = true): void
    {
        $this->intscale = $aIntScale;
    }

    // Calculate an integer autoscale
    public function IntAutoScale($img, $min, $max, $maxsteps, $majend = true): void
    {
    ...
    public function autoScale($img, $min, $max, $maxsteps, $majend = true): void
    {
        if (!is_numeric($min) || !is_numeric($max)) {
    ...
    public function InitConstants($img): void
    {
        if ('x' == $this->type) {
    ...
    public function setConstants($aStart, $aLen): void
    {
...
class DisplayValue
{
    ...
    public function show($aFlag = true): void
    {
        $this->show = $aFlag;
    }

    public function setColor($aColor, $aNegcolor = ''): void
    {
        $this->color    = $aColor;
        $this->negcolor = $aNegcolor;
    }

    public function setFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 8): void
    {
        $this->ff    = $aFontFamily;
        $this->fs    = $aFontStyle;
    ...
    public function applyFont($aImg): void
    {
        $aImg->SetFont($this->ff, $this->fs, $this->fsize);
    }

    public function setMargin($aMargin): void
    {
        $this->margin = $aMargin;
    }
    ...
    public function setAlign($aHAlign, $aVAlign = ''): void
    {
        $this->halign = $aHAlign;
        $this->valign = $aVAlign;
    }

    public function setFormat($aFormat, $aNegFormat = ''): void
    {
        $this->format    = $aFormat;
        $this->negformat = $aNegFormat;
    }

    public function setFormatCallback($aFunc): void
    {
        $this->iFormCallback = $aFunc;
    }

    public function hideZero($aFlag = true): void
    {
        $this->iHideZero = $aFlag;
    }

    public function stroke($img, $aVal, $x, $y): void
    {
        if ($this->show) {
            if ('' == $this->negformat) {
...
class Plot
{
    ...
    public function strokeDataValue($img, $aVal, $x, $y): void
    {
        $this->value->Stroke($img, $aVal, $x, $y);
    }

    // Set href targets for CSIM
    public function setCSIMTargets($aTargets, $aAlts = '', $aWinTargets = ''): void
    {
    ...
    public function setLineWeight($aWeight = 1): void
    {
        $this->line_weight = $aWeight;
    }

    public function setCenter($aCenter = true): void
    {
        $this->center = $aCenter;
    }
