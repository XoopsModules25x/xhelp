...
class OceanTheme extends Theme
{
    ...
    public function SetupGraph($graph): void
    {
        // graph
        /*
        $img = $graph->img;
    ...
    public function SetupPieGraph($graph): void
    {
        // graph
        $graph->SetFrame(false);
    ...
    public function PreStrokeApply($graph): void
    {
        if ($graph->legend->HasItems()) {
            $img = $graph->img;
            $graph->SetMargin($img->raw_left_margin, $img->raw_right_margin, $img->raw_top_margin, is_numeric($img->raw_bottom_margin) ? $img->raw_bottom_margin : $img->height * 0.25);
        }
    }

    public function ApplyPlot($plot): void
    {
