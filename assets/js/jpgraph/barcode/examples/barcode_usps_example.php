...
class barcode_usps_example
{
    ...
    public function _USPS_chkd($aData)
    {
        $n = mb_strlen($aData);
    ...
    public function GetPICwithZIP($aZIP, $aServiceType, $aDUNS, $aSeqNbr)
    {
        ...
        $cd   = $this->_USPS_chkd(mb_substr($data, 8));
    ...
    public function GetPIC($aServiceType, $aDUNS, $aSeqNbr)
    {
