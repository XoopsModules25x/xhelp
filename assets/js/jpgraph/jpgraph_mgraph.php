...
class jpgraph_mgraph
{
    ...
    public function SetFrame($aFlg, $aColor = 'black', $aWeight = 1): void
    {
        $this->iDoFrame     = $aFlg;
    ...
    public function SetBackgroundImage($aFileName, $aCenter_aX = null, $aY = null): void
    {
    ...
    public function _strokeBackgroundImage(): void
    {
        ...
        if (null === $this->background_image_x || null === $this->background_image_y) {
    ...
    public function AddMix($aGraph, $x = 0, $y = 0, $mix = 100, $fx = 0, $fy = 0, $w = 0, $h = 0): void
    {
        $this->_gdImgHandle($aGraph->Stroke(_IMGHandler), $x, $y, $fx = 0, $fy = 0, $w, $h, $mix);
    }

    public function Add($aGraph, $x = 0, $y = 0, $fx = 0, $fy = 0, $w = 0, $h = 0): void
    {
        $this->_gdImgHandle($aGraph->Stroke(_IMGHandler), $x, $y, $fx = 0, $fy = 0, $w, $h);
    }

    public function _gdImgHandle($agdCanvas, $x, $y, $fx = 0, $fy = 0, $w = 0, $h = 0, $mix = 100): void
    {
        if (0 == $w) {
            $w = @imagesx($agdCanvas);
        }
    ...
    public function SetShadow($aShowShadow = true, $aShadowWidth = 4, $aShadowColor = 'gray@0.3'): void
    {
    ...
    public function StrokeTitle($image, $w, $h): void
    {
        // Stroke title
        if ('' !== $this->title->t) {
            $margin = 3;
    ...
    public function Stroke($aFileName = '')
    {
        ...
        if (null !== $this->iWidth && 0 !== $this->iWidth) {
            $w = $this->iWidth;
        }
        if (null !== $this->iHeight && 0 !== $this->iHeight) {
            $h = $this->iHeight;
        }
