...
class jpgraph_date extends LinearScale
{
    private $date_format     = '';
    ...
    public function AdjTime($aTime, $aRound = 0, $aHourType = false, $aMinType = false, $aSecType = false)
    {
        ...
        if (false !== $aHourType) {
            ...
            if (0 == $aRound) {
                ...
                if ((0 == $h % $hourAdj[$aHourType]) && ($i > 0 || $s > 0)) {
                    $h++;
                }
    ...
    public function DoDateAutoScale($aStartTime, $aEndTime, $aDensity = 0, $aAdjust = true)
    {
        ...
        $scalePoints = [
            ...
            SECPERDAY * 90,
            [
                [SECPERDAY * 30, SECPERDAY * 14, SECPERDAY * 7, SECPERDAY],
            ...
            SECPERDAY * 30,
            [
                [SECPERDAY * 14, SECPERDAY * 7, SECPERDAY * 2, SECPERDAY],
            ...
            SECPERDAY * 7,
            [
                [SECPERDAY, SECPERHOUR * 12, SECPERHOUR * 6, SECPERHOUR * 2],
            ...
            SECPERDAY,
            [
                [SECPERDAY, SECPERHOUR * 12, SECPERHOUR * 6, SECPERHOUR * 2, SECPERHOUR],
            ...
            SECPERHOUR * 12,
            [
                [SECPERHOUR * 2, SECPERHOUR, SECPERMIN * 30, 900, 600],
            ...
            SECPERHOUR * 2,
            [
                [SECPERHOUR, SECPERMIN * 30, 900, 600, 300],
                [1800, 900, 300, 120, 60],
                [1, HOURADJ_1, 1, MINADJ_30, 1, MINADJ_15, 1, MINADJ_10, 1, MINADJ_5],
            ],
            ...
            SECPERMIN * 30,
            [
                [SECPERMIN * 15, SECPERMIN * 10, SECPERMIN * 5, SECPERMIN],
                [300, 300, 60, 10],
    ...
    public function SetDateFormat($aFormat): void
    {
    ...
    public function SetDateAlign($aStartAlign, $aEndAlign = false): void
    {
        if (false === $aEndAlign) {
    ...
    public function SetTimeAlign($aStartAlign, $aEndAlign = false): void
    {
        if (false === $aEndAlign) {
            $aEndAlign = $aStartAlign;
        }
    ...
    public function AutoScale($img, $aStartTime, $aEndTime, $aNumSteps, $_adummy = false): void
    {
