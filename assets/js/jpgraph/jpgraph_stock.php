...
class StockPlot extends Plot
{
    ...
    public function SetColor($aColor, $aColor1 = 'white', $aColor2 = 'darkred', $aColor3 = 'darkred'): void
    {
        $this->color        = $aColor;
    ...
    public function HideEndLines($aHide = true): void
    {
    ...
    public function ModBox($img, $xscale, $yscale, $i, $xl, $xr, $neg): void
    {
    }
} // Class
...
class BoxPlot extends StockPlot
{
    ...
    public function SetMedianColor($aPos, $aNeg): void
    {
        $this->iPColor = $aPos;
        $this->iNColor = $aNeg;
    }
