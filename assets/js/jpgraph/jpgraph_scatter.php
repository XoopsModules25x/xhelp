...
class FieldArrow
{
    ...
    public function SetSize($aSize, $aArrowSize = 2): void
    {
        $this->iSize      = $aSize;
    ...
    public function Stroke($aImg, $x, $y, $a): void
    {
...
class FieldPlot extends Plot
{
    ...
    {
        if ('' != $this->legend) {
            $aGraph->legend->Add($this->legend, $this->mark->fill_color, $this->mark, 0, $this->legendcsimtarget, $this->legendcsimalt, $this->legendcsimwintarget);
        }
    }
}
...
class ScatterPlot extends Plot
{
    ...
    //---------------
    // PUBLIC METHODS
    public function SetImpuls($f = true): void
    {
        $this->impuls = $f;
    }

    public function SetStem($f = true): void
    {
        $this->impuls = $f;
    }

    // Combine the scatter plot points with a line
    public function SetLinkPoints($aFlag = true, $aColor = 'black', $aWeight = 1, $aStyle = 'solid'): void
    {
