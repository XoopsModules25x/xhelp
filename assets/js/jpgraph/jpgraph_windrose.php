...
require_once __DIR__ . '/jpgraph_glayout_vh.inc.php';
...
class WindrosePlotScale
{
    ...
    public function SetMaxValue($aMax): void
    {
        $this->iMax     = $aMax;
        $this->iNumCirc = $this->GetNumCirc();
        $this->iMaxVal  = $this->iNumCirc * $this->iDelta;
    ...
    public function Set($aMax, $aDelta = null): void
    {
        if (null === $aDelta) {
    ...
    public function AutoScale($aRadius, $aMinDist = 30): void
    {
    ...
    public function Hide($aFlg = true): void
    {
    ...
    public function SetLabelAlign($aAlign): void
    {
        $this->iLblAlign = $aAlign;
    }

    public function SetLabelFormat($aFmt): void
    {
        $this->iLblFmt = $aFmt;
    }

    public function SetLabelFillColor($aBkgColor, $aBorderColor = false): void
    {
    ...
    public function SetFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 10): void
    {
    ...
    public function SetZFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 10): void
    {
    ...
    public function SetZeroLabel($aTxt): void
    {
        $this->iLblZeroTxt = $aTxt;
    }

    public function SetZFontColor($aColor): void
    {
        $this->iZFontColor = $aColor;
    }

    public function StrokeLabels($aImg, $xc, $yc, $ri, $rr): void
    {
        if ($this->iHideLabels) {
            return;
        }
...
class LegendStyle
{
    ...
    public function SetLFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 10): void
    {
        $this->iLblFontFamily = $aFontFamily;
        $this->iLblFontStyle  = $aFontStyle;
        $this->iLblFontSize   = $aFontSize;
    ...
    public function SetTFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 10): void
    {
        $this->iTxtFontFamily = $aFontFamily;
        $this->iTxtFontStyle  = $aFontStyle;
        $this->iTxtFontSize   = $aFontSize;
    ...
    public function SetCFont($aFontFamily, $aFontStyle = FS_NORMAL, $aFontSize = 10): void
    {
        $this->iCircleFontFamily = $aFontFamily;
        $this->iCircleFontStyle  = $aFontStyle;
        $this->iCircleFontSize   = $aFontSize;
    ...
    public function SetTFontColor($aColor): void
    {
        $this->iTxtFontColor = $aColor;
    }

    public function SetLFontColor($aColor): void
    {
        $this->iLblFontColor = $aColor;
    }

    public function SetCFontColor($aColor): void
    {
        $this->iCircleFontColor = $aColor;
    }

    public function SetCircleWeight($aWeight): void
    {
        $this->iCircleWeight = $aWeight;
    }

    public function SetCircleRadius($aRadius): void
    {
        $this->iCircleRadius = $aRadius;
    }

    public function SetCircleColor($aColor): void
    {
        $this->iCircleColor = $aColor;
    }

    public function SetCircleText($aTxt): void
    {
        $this->iZCircleTxt = $aTxt;
    }

    public function SetMargin($aMarg, $aBottomMargin = 5): void
    {
        $this->iMargin       = $aMarg;
        $this->iBottomMargin = $aBottomMargin;
    }

    public function SetLength($aLength): void
    {
        $this->iLength = $aLength;
    }

    public function Show($aFlg = true): void
    {
        $this->iShow = $aFlg;
    }
    ...
    public function SetFormat($aFmt): void
    {
        $this->iFormatString = $aFmt;
    }

    public function SetText($aTxt): void
    {
        $this->iTxt = $aTxt;
    }
}
...
class WindrosePlot
{
    ...
    public function SetDataKeyEncoding($aEncoding): void
    {
    ...
    public function SetRadialColors($aColors): void
    {
        $this->iRadialColorArray = $aColors;
    }

    public function SetRadialWeights($aWeights): void
    {
        $this->iRadialWeightArray = $aWeights;
    }

    public function SetRadialStyles($aStyles): void
    {
        $this->iRadialStyleArray = $aStyles;
    }

    public function SetBox($aColor = 'black', $aWeight = 1, $aStyle = 'solid', $aShow = true): void
    {
        $this->iShowBox   = $aShow;
    ...
    public function SetLabels($aLabels): void
    {
        $this->iLabels = $aLabels;
    }

    public function SetLabelMargin($aMarg): void
    {
        $this->iLabelMargin = $aMarg;
    }

    public function SetLabelFormat($aLblFormat): void
    {
        $this->iLabelFormatString = $aLblFormat;
    }

    public function SetCompassLabels($aLabels): void
    {
        if (16 != count($aLabels)) {
    ...
    public function SetCenterSize($aSize): void
    {
        $this->iCenterSize = $aSize;
    }

    // Alias for SetCenterSize
    public function SetZCircleSize($aSize): void
    {
        $this->iCenterSize = $aSize;
    }

    public function SetFont($aFFam, $aFStyle = FS_NORMAL, $aFSize = 10): void
    {
    ...
    public function SetGridColor($aColor1, $aColor2): void
    {
        $this->iGridColor1 = $aColor1;
        $this->iGridColor2 = $aColor2;
    }

    public function SetGridWeight($aGrid1 = 1, $aGrid2 = 2): void
    {
        $this->iCircGridWeight   = $aGrid1;
        $this->iRadialGridWeight = $aGrid2;
    }

    public function SetRadialGridStyle($aStyle): void
    {
        $aStyle = \mb_strtolower($aStyle);
    ...
    public function SetRanges($aRanges): void
    {
        $this->iRanges = $aRanges;
    }

    public function SetRangeStyle($aStyle): void
    {
        $this->iRangeStyle = $aStyle;
    }

    public function SetRangeColors($aLegColors): void
    {
        $this->iLegColors = $aLegColors;
    }

    public function SetRangeWeights($aWeights): void
    {
        $n = count($aWeights);
        for ($i = 0; $i < $n; ++$i) {
    ...
    // Alias for SetPos()
    public function SetCenterPos($aX, $aY): void
    {
        $this->iX = $aX;
        $this->iY = $aY;
    }
    ...
    public function SetAntiAlias($aFlag): void
    {
    ...
    public function _ThickCircle($aImg, $aXC, $aYC, $aRad, $aWeight, $aColor): void
    {
    ...
    public function _StrokeWindLeg($aImg, $xc, $yc, $a, $ri, $r, $weight, $color): void
    {
    ...
    public function _StrokeLegend($aImg, $x, $y, $scaling = 1, $aReturnWidth = false)
    {
        ...
        if ('' != $this->legend->iTxt) {
            ...
            $y -= /*$this->legend->iTxtMargin + */
                $value->GetHeight($aImg);
        }
        ...
        while ($i < $this->scale->iMaxNum) {
            ...
            if (RANGE_OVERLAPPING == $this->iRangeStyle) {
    ...
    public function SetAutoScaleAngle($aIsRegRose = true): void
    {
        ...
        if ($aIsRegRose) {
            ...
            for ($i = 0; $i < 16; ++$i) {
                ...
                } elseif (!empty($this->iData[mb_strtolower($dtxt)])) {
                    $data[$i] = $this->iData[mb_strtolower($dtxt)];
            ...
            foreach ($this->iData as $dir => $leg) {
                if (!is_numeric($dir)) {
                    $pos = array_search(mb_strtoupper($dir), $this->iAllDirectionLabels, true);
                    if (false !== $pos) {
                        $dir = $pos * 22.5;
                    }
                }
    ...
    public function SetLabelPosition($aPos): void
    {
        $this->iLabelPositioning = $aPos;
    }

    public function _StrokeFreeRose($dblImg, $value, $scaling, $xc, $yc, $r, $ri): void
    {
        // Plot radial grid lines and remember the end position
        // and the angle for later use when plotting the labels
        if (WINDROSE_TYPEFREE != $this->iType) {
        ...
        foreach ($this->iData as $dir => $legdata) {
            if (true === in_array($dir, $this->iAllDirectionLabels, true)) {
                $a = $this->iStandardDirections[mb_strtoupper($dir)];
                ...
                if (KEYENCODING_CLOCKWISE == $this->iOrdinalEncoding) {
                    $dir = 360 - $dir;
                }
        ...
        if (LBLPOSITION_EDGE == $this->iLabelPositioning) {
        ...
        for ($i = 0; $i < $num; ++$i) {
            ...
            if (LBLPOSITION_CENTER == $this->iLabelPositioning) {
                $dx = $dy = 0;
            } else {
                // LBLPOSIITON_EDGE
    ...
    public function _StrokeRegularRose($dblImg, $value, $scaling, $xc, $yc, $r, $ri): void
    {
    ...
    public function Stroke($aGraph): void
    {
        $aImg = $aGraph->img;
        ...
        if (WINDROSE_TYPEFREE == $this->iType) {
            ...
            // counted clock-wise
            if (KEYENCODING_CLOCKWISE == $this->iOrdinalEncoding) {
                if (WINDROSE_TYPE16 == $this->iType) {
                    $const1 = 19;
                    $const2 = 16;
                } elseif (WINDROSE_TYPE8 == $this->iType) {
                    $const1 = 9;
                    $const2 = 8;
                } else {
                    $const1 = 4;
...
class WindroseGraph extends Graph
{
    ...
    //---------------
    // PUBLIC METHODS
    public function Add($aObj): void
    {
        if ($aObj && is_array($aObj)) {
            $cl = $aObj[0];
        } else {
            $cl = $aObj;
        }
    ...
    public function SetColor($c): void
    {
