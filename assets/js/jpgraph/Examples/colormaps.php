...
require_once \dirname(__DIR__) . '/jpgraph_canvas.php';
require_once \dirname(__DIR__) . '/jpgraph_colormap.inc.php';

class colormaps
{
    public const WIDTH     = 600; // Image width
    public const LMARG     = 90;  // Left margin
    public const RMARG     = 25;  // Right margin
    public const MAPMARG   = 35;  // Map margin between each map
    public const MODHEIGHT = 30; // Module height (=Map height)
    public const YSTART    = 60; // Start coordinate for map list

    public function Draw($aTitle, $aStart, $aEnd, $n = 64, $aReverse = false, $addColorNames = false): void
    {
