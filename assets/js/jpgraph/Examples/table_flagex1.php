...
require \dirname(__DIR__) . '/jpgraph_canvas.php';
require \dirname(__DIR__) . '/jpgraph_table.php';
require \dirname(__DIR__) . '/jpgraph_iconplot.php';
require \dirname(__DIR__) . '/jpgraph_flags.php';
