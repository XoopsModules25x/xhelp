...
echo '<small><pre>' . htmlentities($imgmap1, ENT_QUOTES | ENT_HTML5) . '</pre></small>';
?>
<p>
    and
</p>
<?php
// The we display the image map as well
echo '<small><pre>' . htmlentities($imgmap2, ENT_QUOTES | ENT_HTML5) . '</pre></small>';
?>
...
<small><pre>
<?php
echo htmlentities($imgtag1, ENT_QUOTES | ENT_HTML5);
echo htmlentities($imgtag2, ENT_QUOTES | ENT_HTML5);
?>
</pre>
</small>
