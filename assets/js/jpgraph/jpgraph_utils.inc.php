...
class DateScaleUtils
{
    ...
    public static function UseWeekFormat($aFlg): void
    {
        self::$iUseWeeks = $aFlg;
    }

    public static function doYearly($aType, $aMinor = false): void
    {
        $i = 0;
        $j = 0;
        $m = self::$startmonth;
    ...
    public static function doDaily($aType, $aMinor = false): void
    {
        $m = self::$startmonth;
        $y = self::$startyear;
        $d = self::$startday;
    ...
    public static function doWeekly($aType, $aMinor = false): void
    {
        $hpd = 3600 * 24;
        $hpw = 3600 * 24 * 7;
...
class ReadFileData
{
    ...
    public static function FromCSV2($aFile, &$aData, $aOptions = [])
    {
        ...
        $aOptions = array_merge($aDefaults, is_array($aOptions) ? $aOptions : []);
        ...
        $aData = [];
        $aLine = fgetcsv($rh, $aOptions['readlength'], $aOptions['separator'], $aOptions['enclosure']/*, $aOptions['escape']     # PHP >= 5.3 only */);
