 ...
 * @param mixed         $aData
 * @param Interpolation $aFactor factor
 */
function doMeshInterpolate(&$aData, $aFactor): void
{
...
class MeshInterpolate
{
     ...
     * @param mixed $aFactor
     */
    public function IntSquare($aRow, $aCol, $aFactor): void
    {
        if ($aFactor <= 1) {
            return;
        }
     ...
     * @return array interpolated matrice
     */
