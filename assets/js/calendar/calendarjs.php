...
<link
        ...
        href="<?php echo XHELP_ASSETS_PATH; ?>/js/calendar/css/calendar-blue.css">
<script
        type="text/javascript"
        src="<?php echo XHELP_ASSETS_PATH . '/js/calendar/calendar.js'; ?>"></script>
<script type="text/javascript">
    ...
    Calendar._DN = ["<?php echo _CAL_SUNDAY; ?>",
    ...
    Calendar._MN = ["<?php echo _CAL_JANUARY; ?>",
