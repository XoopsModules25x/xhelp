...
//        }
        ...
        $smartsectionCategoryHandler = XoopsModules\Smartsection\Helper::getInstance()->getHandler('Category');
    ...
    public function storeFaq($faq = null)
    {
        ...
        $GLOBALS['smartsection_itemHandler']     = XoopsModules\Smartsection\Helper::getInstance()->getHandler('Item');
        $GLOBALS['smartsection_categoryHandler'] = XoopsModules\Smartsection\Helper::getInstance()->getHandler('Category');
    ...
    {
        $smartsectionHelper = XoopsModules\Smartsection\Helper::getInstance();
