 ...
 * @package JPSpan
 * @subpackage Server
 * @version $Id: PostOffice.php,v 1.1 2005/06/21 15:31:20 eric_juden Exp $
 */
//--------------------------------------------------------------------------------
/**
 * Define
...
/**@ * include 'remoteobject.js';
        ...
        if ( $this->RequestEncoding == 'xml' ) {
            ?>
* include 'request/rawpost.js'; * include 'encode/xml.js';
            <?php
        } else {
            ?>
* include 'request/post.js'; * include 'encode/php.js';
            <?php
        }
        ?>
*/
