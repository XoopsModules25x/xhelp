<div id="help-template" class="outer">
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://xoops.gitbook.io/xhelp-tutorial/" target="_blank">here </a>.
