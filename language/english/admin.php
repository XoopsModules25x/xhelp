...
//0.81
define('_AM_XHELP_UPGRADEFAILED0', "Update failed - couldn't rename field '%s'");
define('_AM_XHELP_UPGRADEFAILED1', "Update failed - couldn't add new fields");
define('_AM_XHELP_UPGRADEFAILED2', "Update failed - couldn't rename table '%s'");
define('_AM_XHELP_ERROR_COLUMN', 'Could not create column in database : %s');
