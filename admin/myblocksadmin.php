...
include_once XOOPS_ROOT_PATH . "/modules/smartclient/include/functions.php";
...
function list_blocks()
{
    ...
    //echo "<img id='toptableicon' src=" . XOOPS_URL . "/modules/" . $xoopsModule->dirname() . "/images/icon/close12.gif alt='' /></a>&nbsp;" . _AM_SCLIENT_BLOCKS . "</h3>";
    //echo "<div id='toptable'>";
    //echo "<span style=\"color: #567; margin: 3px 0 12px 0; font-size: small; display: block; \">" . _AM_SCLIENT_BLOCKSTXT . "</span>";
	...
	<form action='admin.php' name='blockadmin' method='post'>
		...
		<tr valign='middle'>
			<th>"._AM_TITLE."</th>
			<th align='center' nowrap='nowrap'>"._AM_XHELP_POSITION."</th>
...
echo $indexAdmin->addNavigation('blocksadmin.php');
