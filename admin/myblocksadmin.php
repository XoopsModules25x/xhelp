...
require_once XOOPS_ROOT_PATH . '/modules/smartclient/include/functions.php';
...
function list_blocks()
{
    ...
    //echo "<img id='toptableicon' src=" . XOOPS_URL . "/modules/" . $xoopsModule->dirname() . "/assets/images/icon/close12.gif alt=''></a>&nbsp;" . _AM_SCLIENT_BLOCKS . "</h3>";
